...
import { ArrowRight, Factory, Zap, Building2, Boxes, Construction, Gauge } from "lucide-react";
    ...
    <div className="w-full bg-slate-50 min-h-screen">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-indigo-600/20 rounded-full blur-[120px] pointer-events-none mix-blend-screen"></div>
          ...
          <div className="container mx-auto max-w-5xl">
            ...
            >
              <motion.div variants={fadeInUp} className="mb-6">
                <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-indigo-500/20 text-indigo-300 font-medium text-sm border border-indigo-500/30 backdrop-blur-md shadow-[0_0_20px_rgba(99,102,241,0.15)]">
                  <Factory size={14} /> Integração Off-Site
                </span>
              </motion.div>
              
              <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight leading-[1.1]">
                Shelters Modulares <br className="hidden md:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-300 drop-shadow-[0_0_30px_rgba(99,102,241,0.2)]">MT & Trafo BT</span>
              </motion.h1>
      ...
      <section className="relative -mt-16 z-20 container mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            {[
              { icon: Gauge, title: "-60%", desc: "Tempo de Canteiro de Obras", color: "indigo" },
              { icon: Construction, title: "Zero", desc: "Obra Civil Tradicional", color: "cyan" },
              { icon: Boxes, title: "100%", desc: "Testado em Fábrica", color: "blue" },
            ].map((stat, idx) => (
          ...
          <div className="space-y-32 max-w-6xl mx-auto">
            ...
            >
              <div className="lg:w-1/2 space-y-6 order-2 lg:order-1">
                ...
                <h2 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight">
                  Construção Off-Site. <br/> Instalação Flash.
                </h2>
              ...
              <div className="lg:w-1/2 w-full order-1 lg:order-2">
                <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[4/3] group">
                  ...
                  <img src={imgTeste} alt="Eletrocentro" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="lg:w-1/2 space-y-6 relative z-10">
                ...
                <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight">Turn-Key e Mobilidade</h2>
              ...
              <div className="lg:w-1/2 w-full relative z-10">
                <div className="rounded-[2rem] overflow-hidden shadow-[0_0_50px_rgba(34,211,238,0.2)] aspect-[4/3] group border border-slate-700">
                  <img src={imgTeste} alt="Integração de Painéis" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">Arquitetura Integrada</h2>
            <p className="text-lg md:text-xl text-slate-600 font-light">Uma solução definitiva para ambientes extremos, mineradoras, data centers e energias renováveis.</p>
          </div>
            ...
            {[
              {
                ...
                desc: "Equipamentos montados sob teto da fábrica, livres de poeira e intempéries da obra, garantindo alto rigor técnico.",
                color: "indigo"
              },
              {
                icon: Boxes,
                title: "Expansibilidade",
                desc: "Precisa aumentar a subestação? Módulos adicionais podem ser acoplados aos Shelters existentes perfeitamente.",
                color: "cyan"
              },
              {
                icon: Zap,
                title: "Testes Completos",
                desc: "Os painéis BT e MT já vão energizados e protocolados (FAT - Factory Acceptance Test) prontos para operar.",
                color: "blue"
              }
            ].map((item, i) => (
              <motion.div
                ...
                className="bg-white p-10 rounded-[2rem] border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(99,102,241,0.1)] transition-all duration-300 group hover:-translate-y-2"
              >
      ...
      <section className="py-24 bg-indigo-600 text-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-700 to-blue-600"></div>
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-white/10 blur-[100px] rounded-full pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-cyan-500/20 blur-[100px] rounded-full pointer-events-none"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="max-w-3xl mx-auto space-y-8">
            <motion.h2 variants={fadeInUp} className="text-4xl md:text-6xl font-bold text-white tracking-tight">
              Diminua sua <br/> curva de obra.
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-xl text-indigo-100 leading-relaxed font-light">
              Transforme a implantação das suas salas elétricas de um problema logístico para uma aquisição 100% resolvida e comissionada.
            </motion.p>
            <motion.div variants={fadeInUp} className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button 
                onClick={() => navigate('/contato')}
                size="lg" 
                className="w-full sm:w-auto bg-white hover:bg-slate-50 text-indigo-600 rounded-full px-10 py-7 text-lg font-bold shadow-xl transition-all hover:shadow-2xl hover:scale-105"
              >
                Orçar Shelter Avolt
              </Button>
              <Button 
